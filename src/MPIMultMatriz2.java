...
public class MPIMultMatriz2 {
	...
	public static void main(String[] args) {
		...
		double [] vectorCompletoCN = new double[M];
		...
		if(me!=0) {
				...
				//	System.out.println(vectorResultado[i]);
					...
					for (int i = 0; i < vectorResultado.length; i++) {
						System.out.println(" i:"+i+"vector resultador"+vectorResultado[i]);
					}
							
		}
		///////////////////////////////////////////////////////////////////////////////////////////////
		
		MPI.COMM_WORLD.Gather(vectorResultado, 0,2 , MPI.DOUBLE ,vectorCompletoCN, 0, 2, MPI.DOUBLE, 0); //vectorCompleto = B(M)
		
		///////////////////////////////////////////////////////////////////////////////////////////////
		if(me == 0) {
			
			for (int i = 0; i < vectorCompletoCN.length; i++) {
				System.out.println(vectorCompletoCN[i]);
			}
		}
		////////////////////////////////////////////////////////////////////////////////////////////////
